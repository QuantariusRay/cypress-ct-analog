 ...
 */
function setupHooks(optionalCallback: any) {
 ...
 */
function bootstrapModule(component: any, config: any) {
  var _a;
 ...
 */
function initTestBed(component: any, config: any) {
 ...
 */
function createComponentFixture(component: unknown) {
 ...
 */
function setupFixture(component: any, config: any) {
 ...
 */
function setupComponent(config: any, fixture: any) {
  ...
  if (component.ngOnChanges && config.componentProperties) {
    ...
    // @ts-ignore
    const simpleChanges = Object.entries(componentProperties).reduce((acc: any, [key, value]: [any, any]) => {
 ...
 */
function mount(component: any, config: any = {}) {
 ...
 * })
 */
const createOutputSpy = (alias: any) => {
